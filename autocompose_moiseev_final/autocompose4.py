...
def generate(cname, createvolumes=False):
    ...
    ##################################################
    ##################################################
    #sattrs = c.services.get(cid).attrs   -здесь нужны другие айди
  ...
  #  print(c.services.get(cid).name)
    ...
    print("------------------------------")
   # print(
    #    "вывод placement-constraints  spec и остальное в кавычках    sattrs.get(Spec, {}).get(TaskTemplate, {}).get(Placement, {}).get(Constraints, {})")  # !!! moiseev
